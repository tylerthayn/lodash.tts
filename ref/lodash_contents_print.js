...
Object.keys(data).forEach((obj) => {
	console.log(obj)
	let rows = Math.ceil(data[obj].length / 3)
	for (let i = 0; i<rows; i++) {
		//console.log(Format(data[obj][i]) + Format(data[obj][i+rows]) + Format(data[obj][i+rows+rows]))
	}
